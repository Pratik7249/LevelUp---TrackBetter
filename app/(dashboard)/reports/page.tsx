...
export default function ReportsPage() {
  ...
  const focusDays = Object.entries(state.dailyCheckins).filter(([date, done]) => done && date >= range.from && date <= range.to).length;
